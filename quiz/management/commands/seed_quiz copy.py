...
# -------------------------- Oilness Questions --------------------------#
...

        {
            ...
            "choices": [
              ...
              ("به‌ندرت یا اصلاً نه", {"oiliness": 0})
            ]
        },
        
        {
            ...
            "choices": [
                ...
                ("خیر، همیشه خشک یا نرمال است", {"oiliness": 0})
            ]
        },
        
        {
            ...
            "choices": [
                ...
                ("خیلی دیر یا اصلاً چرب نمی‌شود", {"oiliness": 0})
            ]
        },
        
        {
            ...
            "choices": [
                ...
                ("خیر، اصلاً یا خیلی کم", {"oiliness": 0})
            ]
        },
        
        {
            ...
            "choices": [
                ...
                ("خیر، اصلاً این مشکل را ندارم", {"oiliness": 0})
            ]
        },
